...
object ManualWorkoutEstimates {
    ...
    internal val MET_BY_SPORT: Map<String, Double> = mapOf(
        ...
        // dialog silently stops pre-filling for it (ManualWorkoutEstimatesTest pins that).
        ...
        "american football" to 8.0,
        "australian football" to 8.0,
        "rugby" to 8.3,
        "cricket" to 4.8,
        "softball" to 5.0,
        "handball" to 8.0,
        ...
        "scuba diving" to 7.0,
        "ice skating" to 7.0,
        "inline skating" to 7.5,
        "snowshoeing" to 5.3,
        "gymnastics" to 3.8,
        "fencing" to 6.0,
        "calisthenics" to 3.8,
        "stair climber" to 9.0,
        "boot camp" to 8.0,
        "lacrosse" to 8.0,
        "field hockey" to 7.8,
        "crossfit" to 8.0,
        "mountain biking" to 8.5,
        "skateboarding" to 5.0,
        "stand-up paddleboard" to 6.0,
        "spinning" to 8.5,
        "jump rope" to 11.8,
        "powerlifting" to 6.0,
        "rucking" to 7.0,
        "sand volleyball" to 8.0,
        "archery" to 4.3,
        "fishing" to 3.5,
        "hunting" to 5.0,
        "curling" to 4.0,
        "netball" to 6.0,
        "gaelic football" to 8.0,
        "spikeball" to 6.0,
        "meditation" to 1.3,
        "horseback riding" to 5.5,
        "wheelchair" to 3.5,
        "gaming" to 1.5,
        "motor racing" to 2.5,
    )
